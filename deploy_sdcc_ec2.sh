...
#
# Esempio:
#   ./deploy_sdcc_ec2.sh ubuntu 1.2.3.4 https://github.com/tuo-org/ProgettoSDCC.git main
#
# Assunzioni:
# - Hai una singola chiave .pem in ./keys/ (come nel tuo script precedente).
...
# ---- Individua la chiave .pem in ./keys come nel tuo script
